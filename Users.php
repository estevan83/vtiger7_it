 ...
 * Portions created by vtiger are Copyright (C) AlgomaCRM.
 * All Rights Reserved.
 ************************************************************************************/
$languageStrings = array(
	'LBL_ADD_RECORD'               => 'Nuovo utente'                ,
	...
	'LBL_CURRENCY_CONFIGURATION'   => 'Impostazioni valute e numeri', 
	...
	'LBL_TAG_CLOUD_DISPLAY'        => 'Impostazioni tag cloud'      ,
	'Role'                         => 'Ruolo'                       , 
	'Admin'                        => 'Amministratore'              , 
	'User Name'                    => 'Nome Utente'                 , 
	'Default Activity View'		   => 'Impostazioni vista calendario',
	...
	'LBL_USERDETAIL_INFO'          => 'Dettagli utente', 
	...
	'Asterisk Extension'           => 'Estensione Asterix'          , 
	'Receive Incoming Calls'       => 'Ricezione chiamate in ingresso', 
	...
	'Digit Grouping Pattern'       => 'Formato numerico'      , 
	'Digit Grouping Separator'     => 'Separatore delle migliaia'    , 
	'Symbol Placement'             => 'Posizione valuta'            , 
	'Number Of Currency Decimals'  => 'Numero decimali in valuta' , 
	'Truncate Trailing Zeros'      => 'Tronca gli 0 eccessivi'     , 
	'Default Call Duration'        => 'Durata chiamata (minuti)',
	'Other Event Duration'         => 'Durata altri eventi (Mins)' , 
	'Calendar Hour Format'         => 'Impostazione ore calendario'        ,
	...
	'LBL_CHOOSE_DATE_FORMAT'=> 'Indicare formato data',
	'LBL_PHONE'	=> 'Telefono',
    'Space' => 'Spazio',
    ...
    'LBL_TRANSFER_OWNERSHIP' => 'Trasferimento propriet&agrave;',
    'LBL_TRANSFER_OWNERSHIP_TO_USER' => 'Trasferire la propriet&agrave; ad altro utente',
    'LBL_OWNERSHIP_TRANSFERRED_SUCCESSFULLY' => 'Gestore record cambiato',
    'LBL_OWNERSHIP_TRANSFERRED_FAILED' => 'Impossibile cambiare il gestore del record ',
    'Account Owner' => 'Account Proprietario',
    'Starting Day of the week' => 'Settimana inizia il',
    ...
    'Default Record View' => 'Visualizzazione record predefinita',
    'Left Panel Hide' => 'Nascondi pannelo sinistro',
    'Row Height' => 'Altezza riga',
	'LBL_RESTORE_USER_FAILED' => 'Impossibile ripristinare utente. Esiste già un utente con questo nome.',
  ...
  'LBL_TO_CRM' => 'Login per AlgomaCRM',
  'LBL_INVALID_USER_OR_PASSWORD' => 'Nome utente o password non validi',
  'LBL_INVALID_USER_OR_EMAIL' => 'Nome utente o indirizzo email non validi',
  'LBL_EMAIL_SEND' => 'Abbiamo inviato una email per reimpostare la password.',
  'ForgotPassword' => 'Hai Dimenticato La Password?',
  'LBL_CONNECT_WITH_US' => 'Connettiti con NOI',
  'LBL_GET_MORE' => 'Ottenere di più da AlgomaCRM',
  'LBL_TRANSFER_RECORDS_TO_USER' => 'Trasferire i record utente',
  'LBL_USER_TO_BE_DELETED' => 'Utente Cancellato',
  'LBL_USERS_SETTINGS' => 'Impostazioni utenti',
  'LBL_TEMPLATES' => 'Modelli',
  
  'Other Email' => 'Altra email',
  'Secondary Email' => 'Email alternativa',
  'Postal Code' => 'CAP',
  'CRM Phone Extension' => 'Estensione CRM-telefono',

);
$jsLanguageStrings = array(
		
	//Curency seperator validation messages
	'JS_ENTER_OLD_PASSWORD'=>'Inserire la vecchia passwowd.',
	'JS_ENTER_NEW_PASSWORD'=>'Inserire la nuova password.',
	'JS_ENTER_CONFIRMATION_PASSWORD'=>'Confermare la nuova password.',
	'JS_REENTER_PASSWORDS'=>'Reinserire la password perch&egrave; non coincidono.',
	'JS_INVALID_PASSWORD'=>'Inserire un nome utete e/o password corretti',
	'JS_PASSWORD_CHANGE_FAILED_1'=>'Password utente cambiata per ',
	'JS_PASSWORD_CHANGE_FAILED_2'=>' fallita.  La nuova password deve essere impostata.',
	'JS_PASSWORD_INCORRECT_OLD'=>'Vecchia password errata. Reinserirla correttamente.',
